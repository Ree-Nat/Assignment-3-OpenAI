...
export interface InputTokenCountParams {
    ...
    /**
     * org.example.demo.Model ID used to generate the response, like `gpt-4o` or `o3`. OpenAI offers a
     ...
     * can call.
     */
    tool_choice?: ResponsesAPI.ToolChoiceOptions | ResponsesAPI.ToolChoiceAllowed | ResponsesAPI.ToolChoiceTypes | ResponsesAPI.ToolChoiceFunction | ResponsesAPI.ToolChoiceMcp | ResponsesAPI.ToolChoiceCustom | null;
    /**
